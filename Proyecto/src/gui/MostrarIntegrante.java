...
public class MostrarIntegrante extends PadreIntegrante {
	...
	public MostrarIntegrante(final Equipo equipo) {
		...
		setTitle("Plantilla " + equipo.getNombre());
	...
	private void mostrarIntegrante(IntegranteEquipo integrante){
		...
		if(integrante instanceof Futbolista){
			...
			tfTecnica.setText(String.valueOf(formato.format(((Futbolista) integrante).getTecnica())));
			...
			lblTecnica.setVisible(true);
			tfTecnica.setText(String.valueOf(formato.format(((Tecnico) integrante).getTecnica())));
			tfTecnica.setVisible(true);
		}
